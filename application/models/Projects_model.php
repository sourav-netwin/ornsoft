...
class Projects_model extends CRM_Model
{
    ...
    public function add($data)
    {
        ...
        if (!empty($data['deadline'])) {
            ...
            //ornsoft change |--| BOF -- we have to set deadline as datetime
            $data['deadline'] = to_sql_date($data['deadline'], true);
            //ornsoft change |--| EOF -- we have to set deadline as datetime
        } else {
            unset($data['deadline']);
        }
