...
class Projects extends Admin_controller
{
    ...
    public function index($clientid = '')
    {
        if ($this->input->is_ajax_request()) {
            $this->progibos_base->get_table_data('projects', array(
                'clientid' => $clientid
            ));
        }
    ...
    {
        if ($this->input->is_ajax_request()) {
            $this->progibos_base->get_table_data('staff_projects');
        }
    }
    ...
    public function expenses($id)
    {
        if ($this->input->is_ajax_request()) {
            ...
            $this->progibos_base->get_table_data('project_expenses', array(
                'project_id' => $id
            ));
        }
    }
    ...
    public function discussions($project_id)
    {
        if ($this->projects_model->is_member($project_id) || has_permission('projects', '', 'view')) {
            if ($this->input->is_ajax_request()) {
                $this->progibos_base->get_table_data('project_discussions', array(
    ...
    public function milestones($project_id)
    {
        if ($this->projects_model->is_member($project_id) || has_permission('projects', '', 'view')) {
            if ($this->input->is_ajax_request()) {
                $this->progibos_base->get_table_data('milestones', array(
                    'project_id' => $project_id
                ));
            }
        }
    ...
    public function timesheets($project_id)
    {
        if ($this->projects_model->is_member($project_id) || has_permission('projects', '', 'view')) {
            if ($this->input->is_ajax_request()) {
                $this->progibos_base->get_table_data('timesheets', array(
                    'project_id' => $project_id
                ));
            }
        }
