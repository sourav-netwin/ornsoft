...
class Utilities extends Admin_controller
{
    ...
    public function activity_log()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->progibos_base->get_table_data('activity_log');
        }
    ...
    public function pipe_log()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->progibos_base->get_table_data('ticket_pipe_log');
        }
    ...
    {
        $media_folder = $this->progibos_base->get_media_folder();
