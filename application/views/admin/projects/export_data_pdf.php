...
foreach($timesheets as $timesheet){
    $html .= '<tr style="color:#4a4a4a;">';
        ...
        $html .= '<td>'.strftime(get_current_date_format().' %H:%M', $timesheet['start_time']).'</td>';
        $html .= '<td>'.(!is_null($timesheet['end_time']) ? strftime(get_current_date_format().' %H:%M', $timesheet['end_time']) : '').'</td>';
