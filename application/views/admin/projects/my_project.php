...
<div id="wrapper">
    <div class="content">
        <div class="row">
            <?php echo form_open(admin_url('myprojects/project/' . ( (isset($project))?$project->id:'')),array('id'=>'project_form')); ?>
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php echo render_datetime_input('deadline','project_deadline',$value); ?>
                            </div>
                        </div>
                        <div class="form-group">
								...
								foreach($task_items as $task_item) {
									...
									<div class="col-md-6">
										<div class="checkbox checkbox-primary" style="margin-top:0; margin-bottom:0;">
											<input type="checkbox" class="checklistitem" id="checklist-<?php echo $task_item['id']; ?>" data-id="<?php echo $task_item['id']; ?>"
												<?php if(isset($task_item['show_on_project']) && $task_item['show_on_project'] == 1){echo 'checked';} ?>>
											<label for="checklist-<?php echo $task_item['id']; ?>"><?php echo $task_item['description']; ?></label>
										</div>
									</div>
								<?php } ?>
							<?php } ?>
...
<script>
    <?php if(isset($project)){ ?>
		...
		$('input[type="checkbox"].checklistitem').change(function() {
			...
			$.post(admin_url + 'taskitems/show_checklist_on_project', {
				value: val,
				listid: listid
			});
		});
