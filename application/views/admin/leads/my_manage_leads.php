            ...
            <div class="panel_s">
               <div class="panel-body _buttons">
                  ...
                  <div class="row hide leads-overview">
                     ...
                     <?php
                        $where_not_admin = '(addedfrom = '.get_staff_user_id().' OR ('.get_staff_user_id().' IN (SELECT staff_id FROM tblleadmembers WHERE lead_id=tblleads.id)) OR is_public = 1)';
...
<script>
	function my_init_lead(id) {
		if (init_lead_modal_data(id, admin_url + 'myleads/lead/' + id)) {
