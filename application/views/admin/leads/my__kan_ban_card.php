    ...
    <div class="panel-body lead-body">
        <div class="row">
            <div class="col-md-12 lead-name">
                <a href="<?php echo admin_url('leads/index/'.$lead['id']); ?>" onclick="my_init_lead(<?php echo $lead['id']; ?>);return false;">
            ...
            <div class="col-md-6 text-muted">
                ...
                <a href="<?php echo admin_url('profile/' . $assigned->staff_id); ?>" data-placement="right" data-toggle="tooltip" title="<?php echo get_staff_full_name($assigned->staff_id); ?>" class="mtop5 inline-block">
                    <?php echo staff_profile_image($assigned->staff_id, array(
