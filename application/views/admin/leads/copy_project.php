<div class="modal fade" id="copy_project" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('myprojects/copy/'.$project->id),array('id'=>'copy_form')); ?>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
						<?php echo render_select('projectid',$projects,array('id',array('name')),'project','',array(),array(),'',''); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <?php echo render_datetime_input('deadline','project_deadline'); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
	...
	$('#projectid').change(function(){
		var pId = $(this).val();
		$('#copy_form').attr('action', admin_url + 'myprojects/copy/' + pId);
	});
</script>
</div>
