            ...
            <tbody>
               ...
               <tr id="discount_percent">
                  <td>
                     <div class="row">
                        <div class="col-md-7">
                            <?php //ornsoft change |--| BOF -- rename discount field?>
                            <input placeholder="" name="discount_name" class="input-transparent text-right" value="<?php echo (isset($invoice->discount_name)&&$invoice->discount_name!='')?$invoice->discount_name:_l('invoice_discount'); ?>" aria-invalid="false" type="text" style="width: 80%"> (%)
                            <?php //ornsoft change |--| EOF -- rename discount field?>
                        </div>
                        <div class="col-md-5">
                           <?php
                              $discount_percent = 0;
