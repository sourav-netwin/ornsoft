       ...
       if($expense->recurring > 0 || $expense->recurring_from != NULL) {
        ...
        <div class="col-md-12">
          <h4 class="font-medium text-success no-mtop">
           ...
           <?php echo '<i class="fa fa-question-circle" data-toggle="tooltip" data-title="Expense will be recreated on specific hour of the day based from the setting located at Setup->Settings->Expenses->Cron Job"></i> ' . _l('next_expense_date',_d($next_date)); ?><br />
           <?php } ?>
           <?php
           if($expense->recurring_from != NULL){ ?>
