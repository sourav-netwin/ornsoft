              ...
              // Temporary notice
                $pw_templates = array(
                  ...
                  <div class="alert alert-warning">
                   ...
                   The password email templates are moved here from version 1.2.7 and the folders is deprecated. ProgiBOS will continue to <b>support the folders email templates if exists for a specific time</b>. <b>Its highly recomended to switch to database related email templates.</b>
                   <br />
                   <br />
                   <b>Your existing content from the file templates is not transferred automaticaly</b> here becuase its not possible to handle this in the update. You should manually transfer the content here and apply the necessary merge fields.
                 </div>
                 <?php } ?>
