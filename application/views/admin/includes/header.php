    ...
    <nav>
        ...
        <div class="mobile-menu">
            ...
            <ul class="mobile-icon-menu">
                ...
                <?php } ?>
                <li>
                    <a href="#" class="dropdown-toggle top-timers<?php if(count($_started_timers) > 0){echo ' text-success';} ?>" data-toggle="dropdown"><i class="fa fa-clock-o"></i></a>
            ...
            <ul class="dropdown-menu animated fadeIn">
                ...
                <li class="dropdown-submenu pull-left">
                   ...
                   <ul class="dropdown-menu dropdown-menu-left">
                      ...
                      <?php foreach($this->progibos_base->get_available_languages() as $user_lang) { ?>
...
<li class="icon">
    <a href="#" class="dropdown-toggle top-timers<?php if(count($_started_timers) > 0){echo ' text-success';} ?>" data-toggle="dropdown"><span data-placement="bottom" data-toggle="tooltip" data-title="<?php echo _l('project_timesheets'); ?>"><i class="fa fa-clock-o"></i></span></a>
