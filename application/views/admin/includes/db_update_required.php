...
<body>
    ...
    <p>You need to perform an database upgrade before proceed using ProgiBOS. Your files version is <?php echo wordwrap($this->config->item('migration_version'),1,'.',true); ?> and database version is <?php echo wordwrap($this->_current_version,1,'.',true); ?></p>
