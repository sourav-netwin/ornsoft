...
<div class="<?php echo $col; ?> stats-total-currency total-column">
    <div class="panel_s">
        <div class="panel-body">
            <select class="selectpicker" name="total_currency" onchange="init_proposals_total();" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
...
foreach($totals as $key => $data){
    $class = proposal_status_color_class($data['status']);
    $name = format_proposal_status($data['status'], '', false);
    ?>
