...
foreach ($rResult as $aRow) {
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        if ($aColumns[$i] == 'tax') {
            ...
            $_data = '<span data-toggle="tooltip" data-unit="'.$aRow['unit'].'" data-code="'.$aRow['code'].'" title="' . $aRow['name'] . '" data-taxid="' . $aRow['tax'] . '">' . $aRow['taxrate'] . '%' . '</span>';
