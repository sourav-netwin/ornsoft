...
function check_missing_language_strings($language)
{
    ...
    if (isset($keys_missing)) {
        echo '<br />--<br />Language keys missing please create <a href="https://www.progibos.com/knowledgebase/overwrite-translation-text/" target="_blank">custom_lang.php</a> and add the keys listed above.';
...
function render_admin_js_variables()
{
    ...
    $js_vars     = array(
        ...
        'file_exceeds_maxfile_size_in_form' => _l('file_exceeds_maxfile_size_in_form'),
    ...
    if (get_option('cron_has_run_from_cli') == 0) {
        if (is_admin()) {
            ...
            if ($using_cron_features > 0 && get_option('hide_cron_is_required_message') == 0) {
                ...
                echo '<br />Please follow the cron <a href="https://www.progibos.com/documentation/installation/setup-cpanel-cron-job/" target="_blank">setup guide</a> in order all features to work well.';
                echo '<br /><br /><br />';
