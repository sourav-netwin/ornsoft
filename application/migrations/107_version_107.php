...
class Migration_Version_107 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if (file_exists(APPPATH . 'views/themes/progibos/template_parts/contract_attachments.php')) {
            @unlink(APPPATH . 'views/themes/progibos/template_parts/contract_attachments.php');
        }
  ...
  PRIMARY KEY (`id`)
        ...
        $permissions = $this->progibos_base->get_contact_permissions();
