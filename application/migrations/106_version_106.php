...
class Migration_Version_106 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        if($theme != 'progibos'){
            copy(APPPATH . 'views/themes/progibos/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
