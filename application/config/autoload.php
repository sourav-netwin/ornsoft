...
*/
$autoload['libraries'] = array( 'user_agent', 'encryption','email', 'encoding_lib', 'action_hooks', 'progibos_base' );
$CI = &get_instance();

array_unshift($autoload['libraries'],'database');
$CI->load->helper('progibos_files');
...
$autoload['helper'] = array(
        ...
        'file',
        'form',
        'progibos_action_hooks',
        'progibos_general',
        'progibos_misc',
        'progibos_func',
        'progibos_custom_fields',
        'progibos_merge_fields',
        'progibos_html',
        'progibos_db',
        'progibos_upload',
        'progibos_sales',
        'progibos_themes',
        'progibos_theme_style',
        'progibos_constants',
    );
